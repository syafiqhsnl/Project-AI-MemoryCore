...
- [ ] Scan `projects/plans/sources` for plan files
...
- [ ] Check if `projects/plans/` folder exists — create if needed
- [ ] Write to `projects/plans/project-plan.md` (overwrite if exists)
...
- [ ] Read current `projects/plans/project-plan.md`
...
- [ ] Read `projects/plans/project-plan.md`
...
5. **Line limit enforcement** — if the plan file exceeds `1000` lines during append, rotate (archive old, create fresh).
